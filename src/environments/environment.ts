export const environment = {
  ...
  // apiUrl: 'https://permitprodev.ftsdemo.co.uk:8092/api/', // dev
   // apiUrl: 'https://permitproqa.ftsdemo.co.uk:8094/api/'  ,// QA -HTTPS
 // apiUrl: 'https://permitpro.ftsdemo.co.uk:8096/api/', // Stage -HTTPS
  //apiUrl: "http://permits.tesltd.co.uk:8082/api/", // Tingrith Server Setup --backend 
    name : "(LOCAL)",
    // mockoonUrl: 'http://localhost:3001'
    addressApiUrl: 'https://api.getAddress.io/find/',
    apiKey: 'gnLdWfDuK06mH-eSppXr6g42895',

   // Get address using autocomplete
  addressApiUrlAutocomplete: 'https://api.getAddress.io/autocomplete/',
